...
import { WalletManager, NetworkId, AlgodConfig, WalletState, WalletKey, SignMetadata, SignDataResponse } from '@algorandecosystem/use-wallet';
...
declare const useWallet: () => {
    wallets: _algorandecosystem_use_wallet.BaseWallet[];
    isReady: solid_js.Accessor<boolean>;
    algodClient: solid_js.Accessor<algosdk.Algodv2>;
    activeWallet: () => _algorandecosystem_use_wallet.BaseWallet | null;
    activeWalletAccounts: () => _algorandecosystem_use_wallet.WalletAccount[] | null;
    activeWalletAddresses: () => string[] | null;
    activeWalletState: () => WalletState | null;
    activeAccount: () => _algorandecosystem_use_wallet.WalletAccount | null;
